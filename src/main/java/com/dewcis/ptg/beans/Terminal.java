 ...
 *         &lt;element name="meetingPoints" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Terminal {
    ...
    protected List<String> meetingPoints;
    ...
    public List<String> getMeetingPoints() {
        if (meetingPoints == null) {
            meetingPoints = new ArrayList<String>();
        }
